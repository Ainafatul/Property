...
@section('content')
    ...
    <div id="id">
        <form action="{{route('onNewPortofolio')}}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label class="w-100">Dijual
                                    <input type="number" class="form-control w-100" name="sold" value="">
                                </label>
                            </div>
                            <div class="form-group col-md-12">
                                <label class="w-100">Disewa
                                    <input type="number" class="form-control w-100" name="leased" value="">
                                </label>
                            </div>
                            <div class="form-group col-md-12">
                                <label class="w-100">Konsultasi
                                    <input type="number" class="form-control w-100" name="consult" value="">
                                </label>
                            </div>
                            <div class="form-group col-md-12">
                                <label class="w-100">Agen
                                    <input type="number" class="form-control w-100" name="agent" value="">
                                </label>
                            </div>
                        </div>
                    </div>
