...
<head>
    ...
    <link rel="stylesheet" href="{{asset('lib/bootstrap/OwlCarousel2/dist/assets/owl.theme.default.min.css')}}" type="text/css">
                        ...
                        <div class="col">
                            <figcaption class="figure-caption">
                                <div class="figure-caption text-dark text-justify px-3 pt-2">
                                    <p><span class="quote">"</span> {{$data->message}}<span class="font-weight-bold quote">"</span></p>
                                </div>
                            </figcaption>
                        </div>
                    </div>
