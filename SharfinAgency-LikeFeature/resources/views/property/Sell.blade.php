                            ...
                            <div class="card mx-auto terbaru-card">
                                ...
                                <div class="row" style="padding: 8px">
                                    <div class="col-6" style="padding-right: 4px">
                                        <a href="{{route('DeleteProperty',['id'=>$data->id])}}"
                                           class="btn btn-danger w-100">Delete</a>
                                    </div>
                                    <div class="col-6" style="padding-left: 4px">
                                        <a href="{{route('UpdateProperty',['id'=>$data->id])}}"
                                           class="btn btn-primary w-100" style="color: white">Update</a>
                                    </div>
{{--                                    <form class="col-12" action="{{route('TransactionProperty')}}" method="get">--}}
...
{{--                                        </div>--}}
{{--                                    </form>--}}
                                    <div class="col-12" style="padding-left: 4px; padding-right: 24px; margin-top: 8px">
                                        <a href="{{route('TransactionProperty',['id'=>$data->id])}}" class="btn btn-success w-100" style="color: white; margin-left: 10px; margin-right: 10px;">Terjual</a>
                                    </div>
                                </div>
                            </div>
                        </div>
