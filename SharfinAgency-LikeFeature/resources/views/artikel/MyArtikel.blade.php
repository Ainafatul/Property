                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="btn-group float-right">
                                <a href="{{route('DeleteArticle',['id'=>$data->id])}}" style="color: white" class="btn btn-danger btn-sm float-right mr-1">Delete</a>
                                <a href="{{route('UpdateArticle',['id'=>$data->id])}}" style="color: white" class="btn btn-primary btn-sm float-right">Update</a>
                            </div>
                        </div>
                    </div>
                @endforeach
