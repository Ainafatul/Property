                            ...
                            <div class="card mx-auto terbaru-card">
                                ...
                                <div class="row" style="padding: 8px">
                                    <div class="col-12" style="padding-left: 4px; padding-right: 24px; margin-top: 8px">
                                        <form method="get" action="{{route('AdminTransactionProperty',['id'=>$data->id])}}">
                                            <input value="{{$data->agent}}" name='agent' hidden>
                                            <input type="submit" class="btn btn-success w-100" style="color: white; margin-left: 10px; margin-right: 10px;" value="Terjual">
                                        </form>
                                    </div>
                                </div>
                            </div>
